          ...
          char* i_argv[] )
{
    ...
    l_setup = new tsunami_lab::setups::TsunamiEvent2d( "resources/gebco20/output/tohoku_gebco20_usgs_250m_bath.nc",
                                                       variables,
                                                       "resources/gebco20/output/tohoku_gebco20_usgs_250m_displ.nc",
                                                       variables,
                                                       l_scaleX,
                                                       l_scaleY );
