...
private:
    ...
    // number of cells that can be utilized by a vector
    t_idx m_xCells_vec_full = 1;

    // number of cells that remain from a vector usage
    t_idx m_xCells_vec_remaining = 1;
